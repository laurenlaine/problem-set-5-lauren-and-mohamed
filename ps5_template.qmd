...
# Function to scrape data from each individual page (with its URL)
...
def scrape(year, month):
    ...
    for i in range(250):
        ...
        # Extract titles, dates, categories, and links
        ...
        # If the date is earlier than the set date, break out of the loop
        if date < set_date:
            break
